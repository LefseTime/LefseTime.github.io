      ...
      <div className="main" id="about">
        <div className="scroll">
          ...
          <p className="text"><img src="https://imgur.com/PHKTFi7.png" id="profesh" alt="Sonia standing in front of a brick wall smiling."></img>Hello! I'm Sonia Funkenbusch, a full-stack developer in the Twin Cities, Minnesota with experience in JavaScript,
                    Node.js, MySQL, Sequelize, HTML, and CSS. I have broad interests and experiences ranging from conducting
          ...
          <div className="hobbyPictures">
            <img src="https://imgur.com/gN8UpSy.png" id="zabs" alt="Zabladowski sitting in front of a mirror." title="Zabladowski in a rare moment of repose."></img>
            ...
            <img src="https://imgur.com/IkF1gRQ.png" id="drT" alt="Dr. T on her back with only her back legs sticking out from a box on the cat tree." title="Dr. Terwilliker displaying her usual regal composure."></img>
          </div>
        </div>
      </div>
    );
